        ...
        <form onSubmit={handleCreateNewTask} className={styles.form}>
          ...
          />
            <button className={styles.create}>Criar
              <img className={styles.contentImgSizePlus} src='../plus.png' alt="" />
            </button>
        </form>
    </div>
      ...
      <header className={styles.taskContentContainer}>
        <div className={styles.headerContainer}>
          <div className={styles.headerTaskContainer}>
            <strong className={styles.createdCounterTaskContent}>tarefas criadas
          
           </strong>
             <span className={styles.contentSpan} id='value'>0</span>
          </div>
         <div className={styles.headerTaskContainer}>
            <strong className={styles.doneCounterTaskContent}>Concluidas
